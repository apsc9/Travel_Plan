onload = function () {
    ...
    function createData(){
        const cities = ['Delhi', 'Mumbai', 'Gujarat', 'Goa', 'Kanpur', 'Jammu', 'Hyderabad', 'Bangalore', 'Gangtok', 'Meghalaya','Dehradun','Dharamshala'];
        ...
        for(let i=1;i<V;i++){
            ...
            edges.push({from: i, to: neigh, color: 'yellow',label: String(Math.floor(Math.random()*70)+30)});
        }
